package com.qg.zhongjianyu.dao.ORM;

import com.qg.zhongjianyu.entity.IMultiTableEntity;
...
public class SQLGenerator {
    ...
    public static String generateInsertSQL(Object entity) throws IllegalAccessException {
        ...
        for (int i = 0; i < columnFields.size(); i++) {
            ...
            //如果字段值为字符串,enum类型,LocalDate类型,Time，需要加单引号
            if (fieldValue instanceof String || fieldValue instanceof Enum||fieldValue instanceof java.time.LocalDate||fieldValue instanceof java.sql.Time) {
